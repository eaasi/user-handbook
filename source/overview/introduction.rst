...
design changes unique to the needs of the EaaSI network. This guide is intended to expand upon the description of Demo
and Administration UI functionality in the `EaaS documentation <http://eaas.uni-freiburg.de/docs/>`_, to account for
these changes.
...
.. warning::
  The EaaSI platform is currently in "beta"! Users will experience bugs and inconsistencies not described in this
  documentation. Please see :ref:`links` for assistance. 
