...
These guidelines and screenshots refer to the EaaSI demo administration interface, as provided for the beta release
starting in March 2019. Front-end development will continue throughout the course of the EaaSI project and instructions
may be periodically updated and versioned accordingly.
...
The demo Admin UI landing page features live statistics regarding the health of the local EaaSI node and the network as
...
The sidebar can also be used to access various pages for :ref:`importing resources <add_resources>`,
:ref:`adding emulators <managing_emulators>`, and :ref:`adminstrative settings <administration>`.
...
The "Base Environments" tab is further broken down into three sub-sections: *Private*, *Public* and *Remote*.
  ...
  - *Remote* environments are all :ref:`published <publishing>` environments from other nodes on the network. These
...
using the :ref:`import_object` process. The Object can then be labeled as Software.
...
information for all files contained in the Object (currently works best with file set :ref:`media types <media_types>`).
Siegfried classification is run at the time of Object :ref:`import <import_object>`; at any point the user can re-run
...
selected environment. (Objects should mount in the emulated environment according to their :ref:`media type <media_types>`,
